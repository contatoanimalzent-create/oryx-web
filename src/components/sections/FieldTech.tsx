...
export function FieldTech() {
  return (
    <section id="tecnologia" className="relative py-16 lg:py-24">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="grid items-center gap-8 lg:grid-cols-[1fr_320px]">
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2">
              {TECH.map((t, i) => (
                <Reveal key={t.title} delay={i * 0.06}>
                  <div className="holo-panel h-full rounded-2xl p-5">
          ...
          <Reveal delay={0.1}>
            <div className="phone-scene flex justify-center px-8 py-8">
